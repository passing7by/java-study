...
public class DateExmaple {
	public static void main(String[] args) {
		...
		System.out.println(now); // toString() 자동으로 호출되어 위와 같은 결과가 출력됨
		...
		// 각자 테스트
		sdf = new SimpleDateFormat("yy/M/d E H:m");
		...
		System.out.println(dateTime.format(formatter)); // 날짜객체.format(formatter객체)로 사용
	}
}
