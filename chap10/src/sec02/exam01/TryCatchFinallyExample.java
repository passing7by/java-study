...
//			Class c = Class.forName("java.lang.String"); // 주어진 이름으로 클래스를 찾아서 Class 객체로 반환
			
			// 클새스를 못 찾았을 때
			Class c = Class.forName("java.lang.String2"); // 일반 예외 발생
			
			System.out.println("클래스를 찾았습니다.");
		} catch (ClassNotFoundException e) {
			System.out.println("클래스가 존재하지 않습니다.");
		} finally { // (Obtional) 필요에 따라 작성해도 되고 안해도 됨
