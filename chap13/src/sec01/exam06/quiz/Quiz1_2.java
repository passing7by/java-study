...
//	변경후: {Tom=[전화번호=555-123-4567, 월급=4600000], John=[전화번호=123-456-7890, 월급=4100000], Emma=[전화번호=987-654-3210, 월급=2300000]}
	...
	public static void main(String[] args) {
		Map<String, Information> map1 = new HashMap<String, Information>();
		map1.put("John", new Information("123-456-7890", 3800000));
		map1.put("Emma", new Information("987-654-3210", 2300000));
		map1.put("Tom", new Information("555-123-4567", 4600000));
		
		System.out.println(map1);
		
		// HashMap에 저장된 요소의 값을 수정하는 3가지 방법
		// 방법1: 기존 키에 새로운 값으로 덮어쓰기
//		map1.put("John", new Information("123-456-7890", 4100000)); // 값을 새로운 객체로 갈아치우는 것
		
		// 방법2: 객체 내부 값 직접 변경
//		map1.get("John").setSalary(4100000);
		
		// 방법3: Java 8 이상부터는 replace() 메소드 사용 가능
		// 키가 존재할 때만 값 교체, 키가 없으면 아무 동작 안함
		map1.replace("John", new Information("123-456-7890", 4100000));
...
//		전화번호: 111-111-111
//		월급: 2300000
		Information info1 = map1.get("Emma");
		info1.setPhone("111-111-111");
		
		System.out.println();
		
		System.out.println("===== Emma의 정보 =====");
		System.out.println("전화번호: " + info1.getPhone());
		System.out.println("월급: " + info1.getSalary());
	}
}
