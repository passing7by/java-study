...
public class HashSetExample {
	public static void main(String[] args) {
		...
		// JVM 내부 해시 구현에 의해 우연히 정렬된 것처럼 출력된 것일 분 순서를 보장하지 않음
...
//		System.out.println("합집합: " + class1); // 원본이 변경됨
...
//		System.out.println("교집합: " + class1);
		...
		// HashSet을 이용해 중복 제거
		Set<String> naganoFriends = new HashSet<String>(list);
		System.out.println(naganoFriends);
		
		// 필요 시 다시 List로 변환
		List<String> deduplicatedList = new ArrayList<String>(naganoFriends);
