...
//	- 축구공: 3000원
	...
	public static void main(String[] args) {
		HashSet<Equipment> storage1 = new HashSet<Equipment>();
		HashSet<Equipment> storage2 = new HashSet<Equipment>();
		...
		HashSet<Equipment> temp = new HashSet<Equipment>(storage1);
		temp.addAll(storage2);
		
		Iterator<Equipment> it = temp.iterator();
		...
		temp = new HashSet<Equipment>(storage1);
		temp.retainAll(storage2);
