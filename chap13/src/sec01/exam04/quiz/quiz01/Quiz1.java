...
//	[{제목=Whiplash, 가수=에스파}, {제목=HAPPY, 가수=DAY6}]
	...
	public static void main(String[] args) {
		...
		Set<Song> songs2 = new HashSet<Song>();
		
		songs1.add(new Song("APT.", "로제"));
		songs1.add(new Song("Whiplash", "에스파"));
		songs1.add(new Song("POWER", "G-DRAGON"));
		
		songs2.add(new Song("Whiplash", "에스파"));
		songs2.add(new Song("HAPPY", "DAY6"));
		songs2.add(new Song("HAPPY", "DAY6"));
