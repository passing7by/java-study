package homework.homework13.collection02.view;
...
public class LotteryMenu {
	...
	public void insertObject() {
		...
		for (int i = 0; i < num; i++) {
			...
			while (lc.searchObject().contains(new Lottery(name, phone))) {
	...
	public void winObject() {
		...
		System.out.println("===== 4. 당첨 대상 구성 =====");
		if (lc.winObject() == null) System.out.println("추첨 대상이 4명이상이어야 당첨 대상을 구성할 수 있습니다.");
		else {
