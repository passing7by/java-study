...
public class CharacterConvertStreamExample {
	...
	public static void write(String str) throws Exception {
		FileOutputStream fos = new FileOutputStream("C:/Windows/Temp/test.1.txt"); // 바이트 기반 파일 출력 스트림
	...
	public static String read() throws Exception {
		FileInputStream fis = new FileInputStream("C:/Windows/Temp/test.1.txt"); // 바이트 기반 파일 입력 스트림
