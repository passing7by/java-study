...
public class UUIDExample {
	...
	public static void main(String[] args) {
		...
		// DB에 원본 파일명은 따로 그록해두고, 파일 서버에는 랜덤한 파일명으로 올림
		String updoadDirPath = "C:/upload";
		File uploadDir = new File(updoadDirPath);
		...
		String savedName = UUID.randomUUID().toString() + extension; // 랜덤한 파일명이 만들어짐
